      ...
      <CardHeader className="space-y-4">
        ...
        <div className="text-center">
           <div className="flex justify-center items-center gap-2">
            ...
            <CardTitle className="text-2xl">Connexion Client & Gardien</CardTitle>
          </div>
          <CardDescription>
            Entrez vos identifiants pour accéder au portail client.
          </CardDescription>
        </div>
      </CardHeader>
      <CardContent>
        <div className="grid gap-4">
          ...
          <Button type="submit" className="w-full" asChild>
            <Link href="/customer/dashboard">Connexion</Link>
          </Button>
          <Button type="submit" variant="secondary" className="w-full" asChild>
            <Link href="/customer?new=true">Connexion en tant que Nouveau Client</Link>
          </Button>
        </div>
